...
namespace EXAMENMVC.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDMARCA,NOM_MARCA")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDMARCA,NOM_MARCA")] Marca marca)
        {
            if (id != marca.IDMARCA)
            {
                return NotFound();
